...
export default class CellProperties {
  ...
  private rowStart: number = 2; // for the reviewers;
  private rowEnd: number = 15; // for the reviewers;

  private colStart: number = 0 // for the reviewers;
  private colEnd: number = 4 // for the reviewers;
    ...
    try {
      ...
      for (let i = 0; i < this.cells.length; i++) {
        ...
        if (cells[i].isUncertain) {
          ...
          cells[i].likelihood = 1; //this.cells[i + 2].value;
